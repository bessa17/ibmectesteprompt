...
cid_exemplos = [
  # Capítulo I - Doenças Infecciosas e Parasitárias (A00-B99)
    ...
    ("A16", "Tuberculose das vias respiratórias não confirmada"),
    ...
    ("A26", "Erisipelóide"),
    ("A27", "Leptospirose"),
    ("A28", "Outras doenças bacterianas zoonóticas"),
    ("A30", "Hanseníase"),
    ("A31", "Infecções por outras micobactérias"),
    ("A32", "Listeriose"),
    ("A33", "Tétano neonatal"),
    ...
    ("A40", "Sepse estreptocócica"),
    ("A41", "Outras septicemias"),
    ("A42", "Actinomicose"),
    ("A43", "Nocardiose"),
    ("A44", "Bartonelose"),
    ("A46", "Erisipela"),
    ("A48", "Outras doenças bacterianas"),
    ...
    ("A56", "Outras infecções sexualmente transmissíveis"),
    ("A57", "Cancro mole"),
    ("A58", "Granuloma inguinal"),
    ("A59", "Tricomoníase"),
    ("A60", "Infecção anogenital pelo vírus do herpes"),
    ("A63", "Outras doenças sexualmente transmissíveis"),
    ...
    ("A70", "Infecções por Clamydia psittaci"),
    ("A71", "Tracoma"),
    ("A74", "Outras doenças por Clamydia"),
    ...
    ("A84", "Encefalite por vírus transmitidos por carrapatos"),
    ("A85", "Outras encefalites virais"),
    ("A86", "Encefalite viral não especificada"),
    ("A87", "Meningite viral"),
    ("A88", "Outras infecções virais do sistema nervoso central"),
    ...
    ("A93", "Outras febres por vírus transmitidas por artrópodes"),
    ("A94", "Febre viral transmitida por artrópodes não especificada"),
    ("A95", "Febre amarela"),
    ("A96", "Febre hemorrágica por arenavírus"),
    ("A98", "Outras febres hemorrágicas por vírus"),
    ...
    ("B08", "Outras infecções virais"),
    ("B09", "Infecção viral não especificada"),
    ...
    ("B30", "Conjuntivite por vírus"),
    ("B33", "Outras doenças por vírus"),
    ...
    ("B58", "Toxoplasmose"),
    ("B59", "Pneumocistose"),
    ("B60", "Outras doenças por protozoários"),
    ("B64", "Doença não especificada por protozoários"),
    ("B65", "Esquistossomose"),
    ...
    ("B92", "Seqüelas de hanseníase"),
    ("B94", "Seqüelas de outras doenças infecciosas"),
    ("B95", "Estreptococos e estafilococos como causa de doenças"),
    ("B96", "Outros agentes bacterianos"),
    ("B97", "Vírus como causa de doenças"),
    ("B99", "Outras e as não especificadas doenças infecciosas"),
    ...
    ("C08", "Neoplasia maligna de outras glândulas salivares e as não especificadas"),
    ...
    ("C40", "Neoplasia maligna dos ossos e das cartilagens articulares dos membros"),
    ...
    ("C49", "Neoplasia maligna de outros tecidos conjuntivos e de tecidos moles"),
    ...
    ("C57", "Neoplasia maligna de outros órgãos genitais femininos e os não especificados"),
    ...
    ("C63", "Neoplasia maligna de outros órgãos genitais masculinos e os não especificados"),
    ...
    ("C68", "Neoplasia maligna de outros órgãos urinários e os não especificados"),
    ...
    ("C84", "Linfoma de células T periféricas e cutâneas"),
    ...
    ("D60", "Aplasia pura da série vermelha, adquirida"),
    ...
    ("D76", "Algumas doenças envolvendo tecido linforreticular e sistema reticulohistiocítico"),
    ...
    ("E01", "Transtornos da tireóide relacionados à deficiência de iodo"),
    ...
    ("E35", "Transtornos endócrinos em doenças classificadas em outra parte"),
    ("E40", "Kwashiorkor"),
    ...
    ("E71", "Distúrbios do metabolismo de aminoácidos de cadeia ramificada"),
    ...
    ("E76", "Distúrbios do metabolismo de glicosaminoglicanos"),
    ...
    ("F04", "Síndrome amnésica orgânica"),
    ("F05", "Delirium não superposto a demência"),
    ("F06", "Outros transtornos mentais devidos a lesão e disfunção cerebral e a doença física"),
    ("F07", "Transtornos de personalidade e do comportamento devidos a doença, lesão e disfunção cerebral"),
    ...
    ("F52", "Disfunção sexual não devida a transtorno ou doença orgânica"),
    ...
    ("F59", "Síndromes comportamentais associadas a transtornos das funções fisiológicas e a fatores físicos não especificados"),
    ...
    ("F66", "Transtornos psicológicos e comportamentais associados ao desenvolvimento e à orientação sexual"),
    ...
    ("F95", "Tics"),
    ("F98", "Outros transtornos emocionais e comportamentais com início usualmente ocorrendo na infância ou adolescência"),
    ...
    ("G06", "Abscesso e granuloma intracranianos e intra-espinhais"),
    ("G07", "Abscesso e granuloma intracranianos e intra-espinhais em doenças classificadas em outra parte"),
    ("G08", "Flebite e tromboflebite intracranianas e intra-espinhais"),
    ...
    ("G13", "Atrofias sistêmicas que afetam primariamente o sistema nervoso central em doenças classificadas em outra parte"),
    ...
    ("G43", "Enxaqueca"),
    ("G44", "Outras síndromes de algias cranianas"),
    ("G45", "Ataques isquêmicos transitórios e síndromes correlatas"),
    ("G46", "Síndromes vasculares encefálicas na doença cerebrovascular"),
    ...
    ("G73", "Transtornos da junção mioneural e do músculo em doenças classificadas em outra parte"),
    ...
    ("G97", "Transtornos pós-procedimentais do sistema nervoso não classificados em outra parte"),
    ...
    ("H43", "Transtornos do vítreo"),
    ("H44", "Transtornos do globo ocular"),
    ("H45", "Transtornos do vítreo e do globo ocular em doenças classificadas em outra parte"),
    ("H46", "Neurite óptica"),
    ("H47", "Outros transtornos do nervo óptico e das vias ópticas"),
    ("H48", "Transtornos do nervo óptico e das vias ópticas em doenças classificadas em outra parte"),
    ...
    ("H59", "Transtornos do olho e anexos pós-procedimentos não classificados em outra parte"),
    ...
    ("I24", "Outras formas de doença isquêmica aguda do coração"),
    ...
    ("I39", "Endocardite e transtornos valvulares em doenças classificadas em outra parte"),
    ...
    ("I51", "Complicações e descrições mal definidas de doenças cardíacas"),
    ...
    ("I65", "Oclusão e estenose de artérias pré-cerebrais"),
    ("I66", "Oclusão e estenose de artérias cerebrais"),
    ...
    ("I79", "Transtornos das artérias, arteríolas e capilares em doenças classificadas em outra parte"),
    ...
    ("I89", "Outros transtornos não-infecciosos dos vasos linfáticos e gânglios linfáticos"),
    ("I95", "Hipotensão"),
    ("I97", "Transtornos do aparelho circulatório pós-procedimentos não classificados em outra parte"),
    ("I98", "Outros transtornos do aparelho circulatório em doenças classificadas em outra parte"),
    ("I99", "Outros transtornos e os não especificados do aparelho circulatório"),
    ...
    ("J09", "Influenza por vírus influenza aviário"),
    ("J10", "Influenza por outro vírus influenza identificado"),
    ...
    ("J16", "Pneumonia por outros microorganismos infecciosos"),
    ...
    ("J62", "Pneumoconiose devida a poeira que contém sílica"),
    ...
    ("J66", "Doenças das vias aéreas devidas a poeiras orgânicas específicas"),
    ("J67", "Pneumonite de hipersensibilidade devida a poeiras orgânicas"),
    ("J68", "Afecções respiratórias devidas a inalação de produtos químicos, gases, fumos e vapores"),
    ...
    ("J91", "Derrame pleural em condições classificadas em outra parte"),
    ("J92", "Placa pleural"),
    ("J93", "Pneumotórax"),
    ...
    # Capítulo XI - Doenças do aparelho digestivo (K00-K95)
    ...
    ("K04", "Doenças da polpa e dos tecidos perirradiculares"),
    ...
    ("K64", "Hemorróidas e trombose hemorroidária"),
    ("K65", "Peritonite"),
    ("K66", "Outros transtornos do peritônio"),
    ("K67", "Transtornos do peritônio em doenças infecciosas classificadas em outra parte"),
    ...
    ("K87", "Transtornos da vesícula biliar, vias biliares e pâncreas em doenças classificadas em outra parte"),
    ...
    ("K94", "Avaliação de transtornos gastrointestinais"),
    ("K95", "Complicações gastrointestinais pós-procedimentos"),
    ...
    ("L56", "Outras alterações agudas da pele devidas à radiação ultravioleta"),
    ...
    ("L62", "Transtornos das unhas em doenças classificadas em outra parte"),
    ("L63", "Alopécia areata"),
    ("L64", "Alopécia androgênica"),
    ("L65", "Outras formas não-cicatriciais de perda de cabelos ou pêlos"),
    ("L66", "Alopécia cicatricial [perda de cabelos ou pêlos cicatricial]"),
    ("L67", "Anormalidades da cor e do pedículo do cabelo e dos pêlos"),
    ("L68", "Hipertricose"),
    ("L70", "Acne"),
    ("L71", "Rosácea"),
    ...
    ("L95", "Vasculite limitada a pele não classificada em outra parte"),
    ...
    ("M03", "Artropatias pós-infecciosas e reacionais em doenças classificadas em outra parte"),
    ...
    ("M18", "Artrose da primeira articulação carpometacárpica"),
    ("M19", "Outras artroses"),
    ...
    ("M36", "Transtornos sistêmicos do tecido conjuntivo em doenças classificadas em outra parte"),
    ...
    ("M68", "Transtornos de sinóvias e de tendões em doenças classificadas em outra parte"),
    ...
    ("M86", "Osteomielite"),
    ("M87", "Osteonecrose"),
    ("M88", "Doença óssea de Paget [osteíte deformante]"),
    ...
    ("N12", "Nefrite túbulo-intersticial não especificada como aguda ou crônica"),
    ("N13", "Uropatia obstrutiva e por refluxo"),
    ("N14", "Nefropatia induzida por drogas ou metais pesados"),
    ...
    ("N20", "Cálculos do rim e do ureter"),
    ...
    ("N25", "Transtornos resultantes de função tubular renal alterada"),
    ("N26", "Rim contraído não especificado"),
    ("N27", "Rim pequeno de causa não especificada"),
    ("N28", "Outros transtornos do rim e do ureter não classificados em outra parte"),
    ("N29", "Outros transtornos do rim e do ureter em doenças classificadas em outra parte"),
    ("N30", "Cistite"),
    ("N31", "Disfunção neuromuscular da bexiga não classificada em outra parte"),
    ...
    ("N82", "Fístulas envolvendo o trato genital feminino"),
    ...
    ("N85", "Outros transtornos não-inflamatórios do útero, exceto o colo"),
    ...
    ("N91", "Menstruação ausente, escassa ou pouco frequente"),
    ("N92", "Menstruação excessiva, frequente ou irregular"),
    ...
    ("N95", "Transtornos da menopausa e outros transtornos perimenopáusicos"),
    ...
    ("O11", "Transtornos hipertensivos pré-existentes com proteinúria superposta"),
    ...
    ("O26", "Assistência materna por outras complicações relacionadas principalmente com a gravidez"),
    ("O28", "Achados anormais do rastreamento antenatal da mãe"),
    ("O29", "Complicações de anestesia administrada durante a gravidez"),
    ("O30", "Gravidez múltipla"),
    ("O31", "Complicações específicas de gravidez múltipla"),
    ("O32", "Assistência prestada à mãe por motivo de apresentação anormal, conhecida ou suspeita, do feto"),
    ("O33", "Assistência prestada à mãe por motivo de desproporção conhecida ou suspeita"),
    ("O34", "Assistência prestada à mãe por motivo de anormalidade, conhecida ou suspeita, dos órgãos pélvicos maternos"),
    ("O35", "Assistência prestada à mãe por motivo de anormalidade e lesão fetais, conhecidas ou suspeitas"),
    ("O36", "Assistência prestada à mãe por outro problema fetal conhecido ou suspeito"),
    ("O40", "Polihidrâmnio"),
    ...
    ("O65", "Obstrução do trabalho de parto devida a anormalidade pélvica materna"),
    ("O66", "Outras formas de obstrução do trabalho de parto"),
    ("O67", "Trabalho de parto e parto complicados por hemorragia intraparto não classificada em outra parte"),
    ...
    ("O73", "Retenção da placenta e das membranas, sem hemorragia"),
    ...
    ("O96", "Morte que ocorre mais de 42 dias mas menos de um ano depois do parto, por qualquer causa obstétrica"),
    ...
    ("P12", "Traumatismo do couro cabeludo devido a parto"),
    ("P13", "Traumatismos do esqueleto devido a parto"),
    ("P14", "Traumatismo do sistema nervoso periférico devido a parto"),
    ...
    ("P25", "Enfisema intersticial originado no período perinatal"),
    ...
    ("P54", "Outras hemorragias do recém-nascido"),
    ("P55", "Doença hemolítica do feto e do recém-nascido"),
    ("P56", "Hidropsia fetal devida à doença hemolítica"),
    ("P57", "Kernicterus"),
    ...
    ("P60", "Coagulação intravascular disseminada no feto e no recém-nascido"),
    ("P61", "Outros transtornos hematológicos perinatais"),
    ("P70", "Transtornos transitórios do metabolismo de carboidratos específicos do feto e do recém-nascido"),
    ("P71", "Transtornos transitórios do metabolismo do cálcio e do magnésio do recém-nascido"),
    ("P72", "Outros transtornos endócrinos transitórios do recém-nascido"),
    ("P74", "Outros distúrbios eletrolíticos e metabólicos transitórios do recém-nascido"),
    ("P75", "Íleo meconial"),
    ...
    ("P84", "Outros problemas específicos do recém-nascido"),
    ...
    ("Q04", "Outras malformações congênitas do encéfalo"),
    ("Q05", "Espinha bífida"),
    ("Q06", "Outras malformações congênitas da medula espinal"),
    ...
    ("Q14", "Malformações congênitas do segmento posterior do olho"),
    ("Q15", "Outras malformações congênitas do olho"),
    ("Q16", "Malformações congênitas do ouvido que causam comprometimento da audição"),
    ...
    ("Q60", "Agenesia renal e outras malformações congênitas do rim"),
    ...
    ("Q66", "Malformações congênitas dos pés"),
    ("Q67", "Malformações congênitas osteomusculares da cabeça, da face, da coluna vertebral e do tórax"),
    ("Q68", "Outras malformações congênitas osteomusculares"),
    ("Q69", "Polidactilia"),
    ("Q70", "Sindactilia"),
    ...
    ("Q77", "Osteocondrodisplasia com defeitos de crescimento dos ossos longos e da coluna vertebral"),
    ...
    ("R03", "Pressão arterial anormal sem diagnóstico"),
    ...
    ("R44", "Outros sintomas e sinais relativos às sensações e percepções gerais"),
    ...
    ("R59", "Aumento de gânglios linfáticos"),
    ...
    ("R70", "Velocidade de hemossedimentação elevada e outras anomalias da viscosidade plasmática"),
    ("R71", "Anormalidade de hemácias"),
    ("R72", "Anormalidade de leucócitos não classificada em outra parte"),
    ("R73", "Hiperglicemia não diagnosticada"),
    ...
    ("R84", "Achados anormais de exames de amostras do aparelho respiratório e do tórax"),
    ("R85", "Achados anormais de exames de amostras do aparelho digestivo e da cavidade abdominal"),
    ("R86", "Achados anormais de exames de amostras dos órgãos genitais masculinos"),
    ("R87", "Achados anormais de exames de amostras dos órgãos genitais femininos"),
    ("R89", "Achados anormais de exames de amostras de outros órgãos, sistemas e tecidos"),
    ("R90", "Achados anormais de exames por imagem do sistema nervoso central"),
    ("R91", "Achados anormais de exames por imagem do pulmão"),
    ("R92", "Achados anormais de exames por imagem da mama"),
    ("R93", "Achados anormais de exames por imagem de outras estruturas do corpo"),
    ("R94", "Achados anormais de estudos de função"),
    ("R95", "Síndrome da morte súbita na infância"),
    ("R96", "Outras mortes súbitas de causa desconhecida"),
    ("R97", "Achados anormais de marcadores tumorais"),
    ...
    ("S14", "Traumatismo de nervos e da medula espinal ao nível do pescoço"),
    ("S15", "Traumatismo dos vasos sangüíneos ao nível do pescoço"),
    ("S16", "Traumatismo de tendões e de músculos ao nível do pescoço"),
    ("S17", "Lesão por esmagamento do pescoço"),
    ...
    ("S23", "Luxação, entorse e distensão das articulações e dos ligamentos do tórax"),
    ("S24", "Traumatismo de nervos e da medula espinal ao nível do tórax"),
    ("S25", "Traumatismo dos vasos sangüíneos ao nível do tórax"),
    ...
    ("S30", "Traumatismo superficial do abdome, do dorso, da região lombar e da pelve"),
    ("S31", "Ferimento do abdome, do dorso, da região lombar e da pelve"),
    ...
    ("S34", "Traumatismo de nervos e da medula espinal lombar ao nível do abdome, do dorso e da pelve"),
    ("S35", "Traumatismo dos vasos sangüíneos ao nível do abdome, do dorso e da pelve"),
    ("S36", "Traumatismo de órgãos intra-abdominais"),
    ("S37", "Traumatismo do trato urinário e de órgãos pélvicos"),
    ("S38", "Lesão por esmagamento e amputação traumática de parte do abdome, do dorso e da pelve"),
    ("S39", "Outros traumatismos do abdome, do dorso e da pelve e os não especificados"),
    ...
    ("S46", "Traumatismo de tendões e músculos ao nível do ombro e do braço"),
    ("S47", "Lesão por esmagamento do ombro e do braço"),
    ("S48", "Amputação traumática do ombro e do braço"),
    ("S49", "Outros traumatismos do ombro e do braço e os não especificados"),
    ...
    ("S55", "Traumatismo dos vasos sangüíneos ao nível do antebraço"),
    ("S56", "Traumatismo de músculos e tendões ao nível do antebraço"),
    ...
    ("S65", "Traumatismo dos vasos sangüíneos ao nível do punho e da mão"),
    ("S66", "Traumatismo de músculos e tendões ao nível do punho e da mão"),
    ("S67", "Lesão por esmagamento do punho e da mão"),
    ("S68", "Amputação traumática do punho e da mão"),
    ("S69", "Outros traumatismos do punho e da mão e os não especificados"),
    ...
    ("S75", "Traumatismo dos vasos sangüíneos ao nível do quadril e da coxa"),
    ("S76", "Traumatismo de músculos e tendões ao nível do quadril e da coxa"),
    ("S77", "Lesão por esmagamento do quadril e da coxa"),
    ("S78", "Amputação traumática do quadril e da coxa"),
    ("S79", "Outros traumatismos do quadril e da coxa e os não especificados"),
    ...
    ("S84", "Traumatismo de nervos ao nível da perna"),
    ("S85", "Traumatismo dos vasos sangüíneos ao nível da perna"),
    ("S86", "Traumatismo de músculos e tendões ao nível da perna"),
    ("S87", "Lesão por esmagamento da perna"),
    ("S88", "Amputação traumática da perna"),
    ("S89", "Outros traumatismos da perna e os não especificados"),
    ...
    ("S94", "Traumatismo de nervos ao nível do tornozelo e do pé"),
    ("S95", "Traumatismo dos vasos sangüíneos ao nível do tornozelo e do pé"),
    ("S96", "Traumatismo de músculos e tendões ao nível do tornozelo e do pé"),
    ("S97", "Lesão por esmagamento do tornozelo e do pé"),
    ("S98", "Amputação traumática do tornozelo e do pé"),
    ("S99", "Outros traumatismos do tornozelo e do pé e os não especificados"),
    ...
    ("T04", "Lesões por esmagamento envolvendo múltiplas regiões do corpo"),
    ("T05", "Amputações traumáticas envolvendo múltiplas regiões do corpo"),
    ("T06", "Outros traumatismos envolvendo múltiplas regiões do corpo não classificados em outra parte"),
    ("T07", "Traumatismos múltiplos não especificados"),
    ("T08", "Fratura da coluna, nível não especificado"),
    ("T09", "Outros traumatismos da coluna e do tronco, nível não especificado"),
    ...
    ("T31", "Queimaduras classificadas de acordo com a extensão da superfície corporal atingida"),
    ("T32", "Corrosões classificadas de acordo com a extensão da superfície corporal atingida"),
    ("T33", "Geladura superficial"),
    ("T34", "Geladura com necrose tecidual"),
    ("T35", "Geladura de múltiplas regiões do corpo e geladura não especificada"),
    ("T36", "Envenenamento por antibióticos sistêmicos"),
    ("T37", "Envenenamento por outras substâncias antiinfecciosas e antiparasitárias sistêmicas"),
    ("T38", "Envenenamento por hormônios e seus substitutos e antagonistas sintéticos não classificados em outra parte"),
    ("T39", "Envenenamento por analgésicos, antipiréticos e anti-reumáticos não-opiáceos"),
    ("T40", "Envenenamento por narcóticos e psicodislépticos [alucinógenos]"),
    ("T41", "Envenenamento por anestésicos e gases terapêuticos"),
    ("T42", "Envenenamento por anticonvulsivantes, sedativos, hipnóticos e antiparkinsonianos"),
    ("T43", "Envenenamento por psicotrópicos não classificados em outra parte"),
    ("T44", "Envenenamento por drogas que afetam predominantemente o sistema nervoso autônomo"),
    ("T45", "Envenenamento por substâncias de ação essencialmente sistêmica e substâncias hematológicas não classificadas em outra parte"),
    ("T46", "Envenenamento por substâncias que atuam primariamente sobre o aparelho cardiovascular"),
    ("T47", "Envenenamento por substâncias que atuam primariamente sobre o aparelho gastrointestinal"),
    ("T48", "Envenenamento por substâncias que atuam primariamente sobre os músculos lisos e esqueléticos e sobre o aparelho respiratório"),
    ("T49", "Envenenamento por substâncias de uso tópico que atuam primariamente sobre a pele e as membranas mucosas e por drogas oftalmológicas, otorrinolaringológicas e dentárias"),
    ("T50", "Envenenamento por diuréticos e outras drogas, medicamentos e substâncias biológicas não especificadas"),
    ("T51", "Efeito tóxico do álcool"),
    ("T52", "Efeito tóxico de solventes orgânicos"),
    ("T53", "Efeito tóxico de derivados halogenados de hidrocarbonetos alifáticos e aromáticos"),
    ...
    ("T59", "Efeito tóxico de outros gases, fumos e vapores"),
    ("T60", "Efeito tóxico de pesticidas"),
    ("T61", "Efeito tóxico de substâncias nocivas consumidas como frutos do mar"),
    ...
    ("T64", "Efeito tóxico de aflatoxina e outras micotoxinas contaminantes de alimentos"),
    ("T65", "Efeito tóxico de outras substâncias e as não especificadas"),
    ("T66", "Efeitos não especificados da radiação"),
    ("T67", "Efeitos do calor e da luz"),
    ("T68", "Hipotermia"),
    ("T69", "Outros efeitos da redução da temperatura"),
    ...
    ("T80", "Complicações conseqüentes a infusão, transfusão e injeção terapêutica"),
    ("T81", "Complicações de procedimentos não classificados em outra parte"),
    ("T82", "Complicações de dispositivos protéticos cardíacos e vasculares"),
    ("T83", "Complicações de dispositivos protéticos geniturinários"),
    ("T84", "Complicações de dispositivos protéticos ortopédicos internos"),
    ("T85", "Complicações de outros dispositivos protéticos internos"),
    ("T86", "Rejeição e falha de enxertos"),
    ("T87", "Complicações peculiares de reimplantação e amputação"),
    ...
    ("T92", "Seqüelas de traumatismos de membro superior"),
    ("T93", "Seqüelas de traumatismos de membro inferior"),
    ("T94", "Seqüelas de traumatismos envolvendo regiões múltiplas e não especificadas do corpo"),
    ("T95", "Seqüelas de queimaduras, corrosões e geladuras"),
    ("T96", "Seqüelas de envenenamentos por drogas, medicamentos e substâncias biológicas"),
    ("T97", "Seqüelas de efeitos tóxicos de substâncias de origem não-medicinal"),
    ("T98", "Seqüelas de outros efeitos e dos não especificados de causas externas"),
    ...
    ("V03", "Pedestre traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V04", "Pedestre traumatizado em colisão com um veículo de transporte pesado ou com um ônibus"),
    ("V05", "Pedestre traumatizado em colisão com um trem ou um veículo ferroviário"),
    ...
    ("V13", "Ciclista traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ...
    ("V23", "Motociclista traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ...
    ("V32", "Ocupante de um triciclo motorizado traumatizado em colisão com um veículo a motor de duas ou três rodas"),
    ("V33", "Ocupante de um triciclo motorizado traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V34", "Ocupante de um triciclo motorizado traumatizado em colisão com um veículo de transporte pesado ou um ônibus"),
    ("V35", "Ocupante de um triciclo motorizado traumatizado em colisão com um trem ou um veículo ferroviário"),
    ...
    ("V40", "Ocupante de um automóvel traumatizado em colisão com um pedestre ou um animal"),
    ("V41", "Ocupante de um automóvel traumatizado em colisão com um veículo a pedal"),
    ("V42", "Ocupante de um automóvel traumatizado em colisão com um veículo a motor de duas ou três rodas"),
    ("V43", "Ocupante de um automóvel traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V44", "Ocupante de um automóvel traumatizado em colisão com um veículo de transporte pesado ou um ônibus"),
    ("V45", "Ocupante de um automóvel traumatizado em colisão com um trem ou um veículo ferroviário"),
    ("V46", "Ocupante de um automóvel traumatizado em colisão com outro veículo não-motorizado"),
    ("V47", "Ocupante de um automóvel traumatizado em colisão com um objeto fixo ou parado"),
    ("V48", "Ocupante de um automóvel traumatizado em um acidente de transporte sem colisão"),
    ("V49", "Ocupante de um automóvel traumatizado em outros acidentes de transporte e em acidentes de transporte não especificados"),
    ...
    ("V52", "Ocupante de uma caminhonete traumatizado em colisão com um veículo a motor de duas ou três rodas"),
    ("V53", "Ocupante de uma caminhonete traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V54", "Ocupante de uma caminhonete traumatizado em colisão com um veículo de transporte pesado ou um ônibus"),
    ("V55", "Ocupante de uma caminhonete traumatizado em colisão com um trem ou um veículo ferroviário"),
    ...
    ("V60", "Ocupante de um caminhão traumatizado em colisão com um pedestre ou um animal"),
    ("V61", "Ocupante de um caminhão traumatizado em colisão com um veículo a pedal"),
    ("V62", "Ocupante de um caminhão traumatizado em colisão com um veículo a motor de duas ou três rodas"),
    ("V63", "Ocupante de um caminhão traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V64", "Ocupante de um caminhão traumatizado em colisão com um veículo de transporte pesado ou um ônibus"),
    ("V65", "Ocupante de um caminhão traumatizado em colisão com um trem ou um veículo ferroviário"),
    ("V66", "Ocupante de um caminhão traumatizado em colisão com outro veículo não-motorizado"),
    ("V67", "Ocupante de um caminhão traumatizado em colisão com um objeto fixo ou parado"),
    ("V68", "Ocupante de um caminhão traumatizado em um acidente de transporte sem colisão"),
    ("V69", "Ocupante de um caminhão traumatizado em outros acidentes de transporte e em acidentes de transporte não especificados"),
    ...
    ("V72", "Ocupante de um ônibus traumatizado em colisão com um veículo a motor de duas ou três rodas"),
    ("V73", "Ocupante de um ônibus traumatizado em colisão com um automóvel, caminhonete ou caminhão"),
    ("V74", "Ocupante de um ônibus traumatizado em colisão com um veículo de transporte pesado ou um ônibus"),
    ("V75", "Ocupante de um ônibus traumatizado em colisão com um trem ou um veículo ferroviário"),
    ...
    ("V81", "Ocupante de um trem ou um veículo ferroviário traumatizado em um acidente de transporte"),
    ...
    ("V84", "Ocupante de um veículo especial a motor usado principalmente na agricultura traumatizado em um acidente de transporte"),
    ("V85", "Ocupante de um veículo especial de construções traumatizado em um acidente de transporte"),
    ...
    ("V87", "Acidente de trânsito do tipo especificado mas onde não se sabe o modo de transporte da vítima"),
    ("V88", "Acidente não-de-trânsito do tipo especificado mas onde não se sabe o modo de transporte da vítima"),
    ("V89", "Acidente com veículo a motor ou não-motorizado, tipo(s) de veículo(s) não especificado(s)"),
    ("V90", "Acidente com embarcação causando afogamento e submersão"),
    ("V91", "Acidente com embarcação causando outros traumatismos"),
    ("V92", "Afogamento e submersão relacionados com transporte por água, sem acidente com a embarcação"),
    ("V93", "Acidente a bordo de uma embarcação, sem acidente com a embarcação e não causando afogamento ou submersão"),
    ...
    ("V96", "Acidente de aeronave sem motor causando traumatismo ao ocupante"),
    ...
    ("W00", "Queda no mesmo nível envolvendo gelo ou neve"),
    ("W01", "Queda no mesmo nível por escorregão, tropeção ou passos em falso"),
    ("W02", "Queda envolvendo patins de rodas, para-gelo, patins ou esqui"),
    ...
    ("W08", "Queda envolvendo outro mobiliário"),
    ...
    ("W13", "Queda de ou para fora de um edifício ou outra construção"),
    ("W14", "Queda de árvore"),
    ...
    ("W23", "Apertado, colhido, esmagado ou pinçado em ou entre objetos"),
    ("W24", "Contato com dispositivos de transmissão de força não classificados em outra parte"),
    ("W25", "Contato com vidro cortante"),
    ("W26", "Contato com faca, espada ou adaga"),
    ("W27", "Contato com ferramentas manuais sem motor"),
    ("W28", "Contato com cortador de grama motorizado"),
    ("W29", "Contato com outras ferramentas manuais motorizadas e aparelhos domésticos"),
    ("W30", "Contato com maquinaria agrícola"),
    ("W31", "Contato com outras máquinas e as não especificadas"),
    ("W32", "Projétil de arma de fogo de mão"),
    ("W33", "Projétil de rifle, espingarda e arma de fogo de maior tamanho"),
    ("W34", "Projétil de outras armas de fogo e as não especificadas"),
    ...
    ("W44", "Corpo estranho penetrando através de orifício natural"),
    ("W45", "Corpo estranho ou objeto penetrante através da pele"),
    ...
    ("W55", "Mordedura ou golpe provocado por outros mamíferos"),
    ("W56", "Contato com animais marinhos"),
    ("W57", "Mordedura ou picada de inseto e outros artrópodes não-venenosos"),
    ...
    ("W66", "Afogamento e submersão consecutivos a queda dentro de uma banheira"),
    ("W67", "Afogamento e submersão em piscina"),
    ("W68", "Afogamento e submersão consecutivos a queda dentro de uma piscina"),
    ("W69", "Afogamento e submersão em águas naturais"),
    ("W70", "Afogamento e submersão consecutivos a queda dentro de águas naturais"),
    ...
    ("W77", "Risco à respiração devido ao desabamento, queda de terra ou de outras substâncias"),
    ("W78", "Inalação do conteúdo gástrico"),
    ("W79", "Inalação e ingestão de alimento causando obstrução do trato respiratório"),
    ("W80", "Inalação e ingestão de outro objeto causando obstrução do trato respiratório"),
    ("W81", "Confinado ou aprisionado em um ambiente pobre em oxigênio"),
    ("W83", "Outros riscos especificados à respiração"),
    ("W84", "Risco não especificado à respiração"),
    ("W85", "Exposição a linhas de transmissão elétrica"),
    ("W86", "Exposição a outras correntes elétricas especificadas"),
    ("W87", "Exposição a corrente elétrica não especificada"),
    ("W88", "Exposição a radiação ionizante"),
    ("W89", "Exposição a fontes luminosas artificiais visíveis ou ultravioleta"),
    ("W90", "Exposição a outros tipos de radiação não-ionizante"),
    ("W91", "Exposição a tipo não especificado de radiação"),
    ("W92", "Exposição a calor excessivo de origem artificial"),
    ("W93", "Exposição a frio excessivo de origem artificial"),
    ("W94", "Exposição a alta, baixa e a variações da pressão atmosférica"),
    ("W99", "Exposição a outros fatores ambientais e aos não especificados artificiais"),
    ("X00", "Exposição a fogo não-controlado em edificação ou outra construção"),
    ("X01", "Exposição a fogo não-controlado em local que não edifício ou outra construção"),
    ("X02", "Exposição a fogo controlado em edificação ou outra construção"),
    ("X03", "Exposição a fogo controlado em local que não edifício ou outra construção"),
    ("X04", "Exposição a combustão de material altamente inflamável"),
    ("X05", "Exposição a combustão de roupa de dormir"),
    ("X06", "Exposição a combustão de outro tipo de roupa ou de acessórios do vestuário"),
    ("X08", "Exposição a outros tipos especificados de fumaça, fogo ou chamas"),
    ...
    ("X11", "Contato com água quente de torneira"),
    ("X12", "Contato com outros líquidos quentes"),
    ("X13", "Contato com vapor de água e outros vapores quentes"),
    ("X14", "Contato com ar e gases quentes"),
    ("X15", "Contato com utensílios domésticos quentes"),
    ...
    ("X19", "Contato com outras fontes de calor ou substâncias quentes e as não especificadas"),
    ...
    ("X24", "Contato com centopéias e miriápodes venenosos (tropicais)"),
    ...
    ("X29", "Contato com animais ou plantas venenosos não especificados"),
    ...
    ("X40", "Envenenamento acidental por e exposição a analgésicos, antipiréticos e anti-reumáticos não-opiáceos"),
    ("X41", "Envenenamento acidental por e exposição a anticonvulsivantes, sedativos, hipnóticos, antiparkinsonianos e psicotrópicos não classificados em outra parte"),
    ("X42", "Envenenamento acidental por e exposição a narcóticos e psicodislépticos [alucinógenos] não classificados em outra parte"),
    ("X43", "Envenenamento acidental por e exposição a outras drogas que atuam sobre o sistema nervoso autônomo"),
    ("X44", "Envenenamento acidental por e exposição a outras drogas, medicamentos e substâncias biológicas não especificadas"),
    ("X45", "Envenenamento acidental por e exposição ao álcool"),
    ("X46", "Envenenamento acidental por e exposição a solventes orgânicos e hidrocarbonetos halogenados e seus vapores"),
    ("X47", "Envenenamento acidental por e exposição a outros gases e vapores"),
    ("X48", "Envenenamento acidental por e exposição a pesticidas"),
    ("X49", "Envenenamento acidental por e exposição a outras substâncias químicas e nocivas e às não especificadas"),
    ("X50", "Excesso de esforços e movimentos vigorosos ou repetitivos"),
    ("X51", "Viagem e movimento"),
    ("X52", "Permanência prolongada em ambiente sem gravidade"),
    ("X53", "Privação de alimento"),
    ("X54", "Privação de água"),
    ("X57", "Privação não especificada"),
    ("X58", "Exposição a outros fatores especificados"),
    ("X59", "Exposição a outros fatores e aos não especificados causando traumatismo acidental"),
    ("X60", "Auto-intoxicação por e exposição, intencional, a analgésicos, antipiréticos e anti-reumáticos não-opiáceos"),
    ("X61", "Auto-intoxicação por e exposição, intencional, a drogas antiepilépticas, sedativo-hipnóticas, antiparkinsonianas e psicotrópicas não classificadas em outra parte"),
    ...
    ("X63", "Auto-intoxicação por e exposição, intencional, a outras drogas que atuam sobre o sistema nervoso autônomo"),
    ...
    ("X66", "Auto-intoxicação voluntária por solventes orgânicos, hidrocarbonetos halogenados e seus vapores"),
    ("X67", "Auto-intoxicação voluntária por outros gases e vapores"),
    ("X68", "Auto-intoxicação voluntária por pesticidas"),
    ("X69", "Auto-intoxicação voluntária por outras substâncias químicas e nocivas e às não especificadas"),
    ...
    ("X73", "Lesão autoprovocada intencionalmente por disparo de rifle, espingarda e arma de fogo de maior calibre"),
    ("X74", "Lesão autoprovocada intencionalmente por disparo de outra arma de fogo e de arma de fogo não especificada"),
    ("X75", "Lesão autoprovocada intencionalmente por dispositivo explosivo"),
    ("X76", "Lesão autoprovocada intencionalmente pela fumaça, pelo fogo e pelas chamas"),
    ("X77", "Lesão autoprovocada intencionalmente por vapor de água, vapores ou objetos quentes"),
    ...
    ("X82", "Lesão autoprovocada intencionalmente por impacto de veículo a motor"),
    ...
    ("X87", "Agressão por meio de pesticidas"),
    ...
    ("X94", "Agressão por meio de disparo de rifle, espingarda e arma de fogo de maior calibre"),
    ("X95", "Agressão por meio de disparo de outra arma de fogo e de arma de fogo não especificada"),
    ("X96", "Agressão por meio de dispositivo explosivo"),
    ("X97", "Agressão por meio de fumaça, fogo e chamas"),
    ("X98", "Agressão por meio de vapor de água, vapores e objetos quentes"),
    ("X99", "Agressão por meio de objeto cortante ou penetrante"),
    ("Y00", "Agressão por meio de objeto contundente"),
    ("Y01", "Agressão por meio de precipitação de um lugar elevado"),
    ("Y02", "Agressão por meio de precipitação ou colocação diante de um objeto em movimento"),
    ("Y03", "Agressão por meio de impacto de veículo a motor"),
    ("Y04", "Agressão por meio de força corporal"),
    ("Y05", "Agressão sexual por meio de força corporal"),
    ...
    ("Y10", "Envenenamento por e exposição a analgésicos, antipiréticos e anti-reumáticos não-opiáceos, intenção não determinada"),
    ("Y11", "Envenenamento por e exposição a drogas antiepilépticas, sedativo-hipnóticas, antiparkinsonianas e psicotrópicas não classificadas em outra parte, intenção não determinada"),
    ("Y12", "Envenenamento por e exposição a narcóticos e psicodislépticos [alucinógenos] não classificados em outra parte, intenção não determinada"),
    ("Y13", "Envenenamento por e exposição a outras drogas que atuam sobre o sistema nervoso autônomo, intenção não determinada"),
    ("Y14", "Envenenamento por e exposição a outras drogas, medicamentos e substâncias biológicas e às não especificadas, intenção não determinada"),
    ("Y15", "Envenenamento por e exposição ao álcool, intenção não determinada"),
    ("Y16", "Envenenamento por e exposição a solventes orgânicos, hidrocarbonetos halogenados e seus vapores, intenção não determinada"),
    ("Y17", "Envenenamento por e exposição a outros gases e vapores, intenção não determinada"),
    ("Y18", "Envenenamento por e exposição a pesticidas, intenção não determinada"),
    ("Y19", "Envenenamento por e exposição a outras substâncias químicas e nocivas e às não especificadas, intenção não determinada"),
    ("Y20", "Enforcamento, estrangulamento e sufocação, intenção não determinada"),
    ("Y21", "Afogamento e submersão, intenção não determinada"),
    ("Y22", "Disparo de arma de fogo de mão, intenção não determinada"),
    ("Y23", "Disparo de rifle, espingarda e arma de fogo de maior calibre, intenção não determinada"),
    ...
    ("Y27", "Exposição a vapor de água, vapores e objetos quentes, intenção não determinada"),
    ...
    ("Y32", "Impacto de veículo a motor, intenção não determinada"),
    ("Y33", "Outros eventos especificados, intenção não determinada"),
    ("Y34", "Evento não especificado, intenção não determinada"),
    ("Y35", "Intervenção legal"),
    ("Y36", "Operações de guerra"),
    ("Y40", "Efeitos adversos de antibióticos sistêmicos"),
    ("Y41", "Efeitos adversos de outras drogas antiinfecciosas e antiparasitárias sistêmicas"),
    ...
    ("Y44", "Efeitos adversos de agentes farmacológicos que afetam primariamente os constituintes do sangue"),
    ("Y45", "Efeitos adversos de drogas analgésicas, antipiréticas e antiinflamatórias"),
    ("Y46", "Efeitos adversos de drogas antiepilépticas e antiparkinsonianas"),
    ("Y47", "Efeitos adversos de sedativos, hipnóticos e ansiolíticos"),
    ...
    ("Y51", "Efeitos adversos de drogas que afetam primariamente o sistema nervoso autônomo"),
    ("Y52", "Efeitos adversos de agentes que afetam primariamente o aparelho cardiovascular"),
    ("Y53", "Efeitos adversos de agentes que afetam primariamente o aparelho gastrointestinal"),
    ("Y54", "Efeitos adversos de agentes que afetam primariamente o equilíbrio hidroeletrolítico e o metabolismo de ácido-básico"),
    ("Y55", "Efeitos adversos de agentes que afetam primariamente os músculos lisos e esqueléticos e o aparelho respiratório"),
    ("Y56", "Efeitos adversos de agentes de uso tópico que afetam primariamente a pele e as membranas mucosas e drogas oftalmológicas, otorrinolaringológicas e dentárias"),
    ("Y57", "Efeitos adversos de outras drogas e medicamentos e os não especificados"),
    ...
    ("Y60", "Corte, punção, perfuração ou hemorragia acidental durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y61", "Objeto estranho deixado acidentalmente no corpo durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y62", "Falha de esterilização durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y63", "Falha na dosagem durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y64", "Medicamento ou substância biológica contaminados durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y65", "Outros acidentes durante a prestação de cuidados médicos ou cirúrgicos"),
    ("Y66", "Não administração de cuidados médicos e cirúrgicos"),
    ("Y69", "Acidente não especificado durante a prestação de cuidados médicos e cirúrgicos"),
    ("Y70", "Dispositivos de anestesiologia associados a incidentes adversos"),
    ("Y71", "Dispositivos cardiovasculares associados a incidentes adversos"),
    ("Y72", "Dispositivos utilizados em otorrinolaringologia associados a incidentes adversos"),
    ("Y73", "Dispositivos utilizados em gastroenterologia e em urologia associados a incidentes adversos"),
    ("Y74", "Dispositivos gerais de uso hospitalar e pessoal associados a incidentes adversos"),
    ("Y75", "Dispositivos utilizados em neurologia associados a incidentes adversos"),
    ("Y76", "Dispositivos utilizados em obstetrícia e ginecologia associados a incidentes adversos"),
    ("Y77", "Dispositivos utilizados em oftalmologia associados a incidentes adversos"),
    ("Y78", "Dispositivos utilizados em radiologia associados a incidentes adversos"),
    ("Y79", "Dispositivos ortopédicos associados a incidentes adversos"),
    ("Y80", "Dispositivos utilizados em medicina física associados a incidentes adversos"),
    ("Y81", "Dispositivos utilizados em cirurgia geral e plástica associados a incidentes adversos"),
    ("Y82", "Outros dispositivos médicos e os não especificados associados a incidentes adversos"),
    ("Y83", "Cirurgia e outros procedimentos cirúrgicos como causa de reação anormal do paciente ou de complicação posterior, sem menção de acidente durante a intervenção"),
    ("Y84", "Outros procedimentos médicos como causa de reação anormal do paciente ou de complicação posterior, sem menção de acidente durante o procedimento"),
    ("Y85", "Seqüelas de acidentes de transporte"),
    ("Y86", "Seqüelas de outros acidentes"),
    ("Y87", "Seqüelas de lesões autoprovocadas intencionalmente, de agressão e de eventos de intenção não determinada"),
    ("Y88", "Seqüelas de cuidados médicos e cirúrgicos considerados como causa externa"),
    ...
    ("Y95", "Circunstância relativa a doenças nosocomiais"),
    ("Y96", "Circunstância relativa a condições de trabalho"),
    ("Y97", "Circunstância relativa a condições de poluição ambiental"),
    ("Y98", "Circunstância relativa a condições do modo de vida"),
    ...
    ("Z10", "Exame geral de rotina de determinada subpopulação"),
    ("Z11", "Exame especial de rastreamento de doenças infecciosas e parasitárias"),
    ("Z12", "Exame especial de rastreamento de neoplasias"),
    ("Z13", "Exame especial de rastreamento de outros transtornos e doenças"),
    ...
    ("Z27", "Necessidade de imunização contra combinações de doenças infecciosas"),
    ("Z28", "Imunização não realizada"),
    ("Z29", "Necessidade de outras medidas profiláticas"),
    ("Z30", "Supervisão de anticoncepcional"),
    ...
    ("Z47", "Outro seguimento ortopédico"),
    ...
    ("Z59", "Problemas relacionados com a habitação e as condições econômicas"),
    ("Z60", "Problemas relacionados com o ambiente social"),
    ("Z61", "Problemas relacionados com eventos negativos na infância"),
    ("Z62", "Outros problemas relacionados com a educação da criança"),
    ("Z63", "Outros problemas relacionados com o grupo primário de suporte, inclusive com a situação familiar"),
    ("Z64", "Problemas relacionados com certas condições psicossociais"),
    ("Z65", "Problemas relacionados com outras circunstâncias psicossociais"),
    ("Z70", "Aconselhamento relativo a atitudes, comportamento e orientação em matéria de sexualidade"),
    ("Z71", "Pessoas em contato com os serviços de saúde para outros aconselhamentos e conselhos médicos, não classificados em outra parte"),
    ("Z72", "Problemas relacionados com o estilo de vida"),
    ("Z73", "Problemas relacionados com a dificuldade no manejo da vida"),
...
cid_df = pd.DataFrame(cid_exemplos, columns=["CID", "Descrição CID"])
...
def extrair_nomes(texto):
    padrao_nomes = r"(Titular:\s*|Dep\d+:\s*)([A-ZÀ-Ú\s]+)(?=\s*(?:\||\n))"
    matches = re.findall(padrao_nomes, texto)
    
    nomes = {}
    for prefixo, nome in matches:
        nome_limpo = nome.strip()
        if "Titular" in prefixo:
            nomes["Titular"] = nome_limpo
        else:
            dep_num = re.search(r'Dep(\d+)', prefixo).group(1)
            nomes[f"DEP{dep_num}"] = nome_limpo
    
    return nomes

# ========== EXTRAÇÃO DO QUADRO III ==========
def extrair_quadroIII(pdf_file):
    try:
        ...
        nomes = extrair_nomes(texto_completo)
        
        padrao_quadro = r"(Titular|DEP\d+)\s+(\d{2}/\d{2}/\d{4})\s+(.+?)(?=\n|Titular|DEP\d+|\Z)"
...
if arquivo:
    if arquivo.type != "application/pdf":
        ...
        with st.spinner("Processando arquivo..."):
            ...
            if tabela.empty:
                st.warning("⚠️ Nenhum dado encontrado no PDF. Verifique se o arquivo contém o Quadro III no formato esperado.")
            else:
                ...
                st.dataframe(tabela[["Segurado", "Data", "Descrição", "CID"]], use_container_width=True, height=500)

                # Exportação Excel
                buffer = io.BytesIO()
                with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
                    tabela[["Segurado", "Data", "Descrição", "CID"]].to_excel(writer, index=False, sheet_name="Resumo")
                buffer.seek(0)

                st.download_button(
                    label="📥 Baixar Resumo em Excel",
                    data=buffer,
                    file_name="Resumo_QuadroIII_CID.xlsx",
